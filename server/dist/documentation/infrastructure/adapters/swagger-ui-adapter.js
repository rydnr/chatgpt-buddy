...
class SwaggerUIAdapter extends core_1.Adapter {
    ...
    setupRoutes() {
        ...
        this.app.get(`${this.docPath}/openapi.json`, (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                const spec = yield this.openApiGenerator.generateSpecification();
        ...
        this.app.get(this.docPath, (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                const html = yield this.generateSwaggerHTML();
...
<body>
    ...
    updateSpecification() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.openApiGenerator.generateSpecification();
        });
    }
    /**
     * Generates standalone HTML documentation file
     */
    generateStandaloneDocumentation(outputPath) {
        return __awaiter(this, void 0, void 0, function* () {
            const spec = yield this.openApiGenerator.generateSpecification();
            const html = yield this.generateStandaloneHTML(spec);
            yield fs.writeFile(outputPath, html, 'utf8');
        });
    }
    /**
     * Generates standalone HTML with embedded OpenAPI spec
     */
    generateStandaloneHTML(openApiSpec) {
        return __awaiter(this, void 0, void 0, function* () {
            return `
<!DOCTYPE html>
<html lang="en">
