...
`;
    ...
    <parameter name="todos">[{"content": "Phase 1: Event-Driven Core Migration - Rename Message to Event terminology", "status": "completed", "priority": "high", "id": "phase1-event-migration"}, {"content": "Enhance event infrastructure with learning context and new event types", "status": "completed", "priority": "high", "id": "learning-event-types"}, {"content": "Phase 2: Interactive Learning Browser Extension with dialog UI", "status": "completed", "priority": "high", "id": "phase2-learning-ui"}, {"content": "Integrate Playwright recorder in browser extension", "status": "completed", "priority": "high", "id": "playwright-integration"}, {"content": "Create POC for basic event recording loop", "status": "completed", "priority": "high", "id": "poc-recording-loop"}, {"content": "Phase 3: Persistent Learning Storage with IndexedDB", "status": "completed", "priority": "high", "id": "phase3-storage"}, {"content": "Build smart implementation matching algorithm", "status": "completed", "priority": "medium", "id": "smart-matching"}, {"content": "Design and implement event schemas collaboratively", "status": "completed", "priority": "medium", "id": "event-schema-design"}, {"content": "Implement IndexedDB persistent storage to replace in-memory storage", "status": "completed", "priority": "high", "id": "indexeddb-storage"}, {"content": "Create end-to-end test framework for browser extension communication", "status": "completed", "priority": "high", "id": "e2e-test-framework"}, {"content": "Implement tabSwitchRequested event with title-based tab switching", "status": "completed", "priority": "high", "id": "tab-switch-event"}, {"content": "Refactor message handling from if-blocks to double dispatching pattern", "status": "completed", "priority": "high", "id": "double-dispatch-refactor"}, {"content": "Create Redux-like message store with time-traveling capabilities", "status": "completed", "priority": "high", "id": "message-store-creation"}, {"content": "Integrate message store into background script double dispatch", "status": "pending", "priority": "medium", "id": "message-store-integration"}, {"content": "Create comprehensive tests for message persistence and time-travel", "status": "pending", "priority": "medium", "id": "message-persistence-tests"}, {"content": "Implement time-travel UI components for debugging", "status": "pending", "priority": "low", "id": "time-travel-ui"}, {"content": "Update web-buddy framework roadmap with interactive training system", "status": "completed", "priority": "high", "id": "update-web-buddy-roadmap"}, {"content": "Update typescript-eda roadmap with training events and entities", "status": "completed", "priority": "high", "id": "update-eda-roadmap"}, {"content": "\ud83d\udd34 RED: Create failing test for training UI display", "status": "completed", "priority": "high", "id": "red-training-ui-test"}, {"content": "\ud83d\udfe2 GREEN: Implement minimal training UI to pass test", "status": "completed", "priority": "high", "id": "green-training-ui"}, {"content": "\ud83d\udd34 RED: Create failing test for element selection", "status": "completed", "priority": "high", "id": "red-element-selection"}, {"content": "\ud83d\udfe2 GREEN: Implement element click capture", "status": "completed", "priority": "high", "id": "green-element-capture"}, {"content": "\ud83d\udd34 RED: Create failing test for pattern storage", "status": "completed", "priority": "high", "id": "red-pattern-storage"}, {"content": "\ud83d\udfe2 GREEN: Implement pattern persistence", "status": "completed", "priority": "high", "id": "green-pattern-persistence"}, {"content": "\ud83d\udd35 REFACTOR: Improve training UI and pattern matching", "status": "completed", "priority": "medium", "id": "refactor-training-system"}, {"content": "\ud83c\udfaf Phase 5: TypeScript-EDA Training System Integration", "status": "completed", "priority": "high", "id": "phase5-eda-integration"}, {"content": "Create training domain events (TrainingModeRequested, ElementSelected, etc.)", "status": "completed", "priority": "high", "id": "create-training-events"}, {"content": "Implement TrainingSession entity with @listen decorators", "status": "completed", "priority": "high", "id": "training-session-entity"}, {"content": "Implement AutomationPattern entity with pattern execution", "status": "completed", "priority": "high", "id": "automation-pattern-entity"}, {"content": "Create training infrastructure adapters (UI, storage, matching)", "status": "completed", "priority": "high", "id": "training-infrastructure"}, {"content": "Implement TrainingApplication with @Enable decorators", "status": "completed", "priority": "high", "id": "training-application"}, {"content": "Integration testing for event-driven training system", "status": "completed", "priority": "high", "id": "eda-integration-tests"}, {"content": "\ud83d\ude80 Phase 6: Integration & Testing - Training-Enhanced E2E Testing", "status": "completed", "priority": "high", "id": "phase6-integration-testing"}, {"content": "Implement complete training workflow E2E tests with Playwright", "status": "completed", "priority": "high", "id": "training-workflow-e2e"}, {"content": "Create pattern matching and auto-execution E2E tests", "status": "completed", "priority": "high", "id": "pattern-execution-e2e"}, {"content": "Implement UI interaction testing for element selection", "status": "completed", "priority": "high", "id": "ui-interaction-testing"}, {"content": "Create cross-session pattern persistence tests", "status": "completed", "priority": "high", "id": "cross-session-testing"}, {"content": "Implement multi-tab training pattern sharing tests", "status": "completed", "priority": "high", "id": "multi-tab-testing"}, {"content": "Create error recovery and edge case testing", "status": "pending", "priority": "high", "id": "error-recovery-testing"}, {"content": "Performance optimization with training system", "status": "pending", "priority": "medium", "id": "performance-optimization"}, {"content": "\ud83c\udfaf Phase 7A: File Download Event System Extension", "status": "completed", "priority": "high", "id": "phase7a-download-events"}, {"content": "Add Chrome downloads permission to extension manifest", "status": "completed", "priority": "high", "id": "add-downloads-permission"}, {"content": "Extend domain events for file download operations", "status": "completed", "priority": "high", "id": "extend-download-events"}, {"content": "Implement FileDownload entity with download management", "status": "completed", "priority": "high", "id": "file-download-entity"}, {"content": "Create download infrastructure adapters (Chrome API, file system)", "status": "completed", "priority": "high", "id": "download-infrastructure"}, {"content": "\ud83c\udfaf Phase 7B: Google Images Download Proof of Concept", "status": "completed", "priority": "high", "id": "phase7b-google-images-poc"}, {"content": "Create Google Images automation with download interception", "status": "completed", "priority": "high", "id": "google-images-automation"}, {"content": "Implement download event detection and file path capture", "status": "completed", "priority": "high", "id": "download-path-capture"}, {"content": "Build server file access bridge for downloaded files", "status": "completed", "priority": "high", "id": "server-file-bridge"}, {"content": "\ud83c\udfaf Phase 7C: OpenAPI Documentation System", "status": "completed", "priority": "high", "id": "phase7c-openapi-docs"}, {"content": "Generate OpenAPI spec from domain events and server endpoints", "status": "completed", "priority": "high", "id": "openapi-generation"}, {"content": "Create interactive API documentation with Swagger UI", "status": "completed", "priority": "high", "id": "swagger-ui-setup"}, {"content": "Implement SDK code generation from OpenAPI specification", "status": "completed", "priority": "high", "id": "sdk-code-generation"}]