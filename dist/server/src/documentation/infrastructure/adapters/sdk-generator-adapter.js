...
class SDKGeneratorAdapter extends core_1.Adapter {
     ...
     */
    async generateTypeScriptSDK(outputDir) {
     ...
     */
    async generateTypeScriptClient() {
        return `/*
...
`;
     ...
     */
    async generateTypeScriptExamples() {
        return `/*
...
`;
     ...
     */
    async generateTypeScriptPackageJson() {
     ...
     */
    async generateTypeScriptReadme() {
...
`;
     ...
     */
    async generatePythonSDK(outputDir) {
        await fs.mkdir(outputDir, { recursive: true });
...
//# sourceMappingURL=sdk-generator-adapter.js.map