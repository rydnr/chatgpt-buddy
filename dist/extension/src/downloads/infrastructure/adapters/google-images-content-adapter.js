...
exports.GoogleImagesContentAdapter = void 0;
const core_1 = require("@typescript-eda/core");
const download_events_1 = require("../../domain/events/download-events");
const google_images_downloader_1 = require("../../domain/entities/google-images-downloader");
/**
 ...
 */
class GoogleImagesContentAdapter extends core_1.Adapter {
    constructor() {
        super();
        this.isGoogleImagesPage = false;
        this.downloadButtons = new Map();
        this.observer = null;
        this.downloader = new google_images_downloader_1.GoogleImagesDownloader();
        this.initialize();
    }
    /**
    ...
    async handleImageDownload(img) {
        try {
            ...
            const downloadEvent = new download_events_1.GoogleImageDownloadRequested(this.generateCorrelationId(), {
                src: img.src,
                alt: img.alt,
                title: img.title,
            ...
            if (result instanceof download_events_1.FileDownloadRequested) {
...
exports.GoogleImagesContentAdapter = GoogleImagesContentAdapter;
//# sourceMappingURL=google-images-content-adapter.js.map