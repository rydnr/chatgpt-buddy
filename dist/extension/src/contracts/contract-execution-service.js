...
exports.contractExecution = exports.ContractExecutionService = void 0;
const contract_discovery_adapter_1 = require("./contract-discovery-adapter");
/**
 * Service for executing automation using discovered contracts
 */
class ContractExecutionService {
    constructor() {
        this.discoveryAdapter = contract_discovery_adapter_1.contractDiscovery;
    }
    /**
...
exports.ContractExecutionService = ContractExecutionService;
// Global contract execution service instance
exports.contractExecution = new ContractExecutionService();
//# sourceMappingURL=contract-execution-service.js.map