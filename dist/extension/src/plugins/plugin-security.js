...
exports.PluginSecurityManager = exports.SecurityViolationType = exports.APIAccessLevel = exports.PermissionType = void 0;
...
})(APIAccessLevel || (exports.APIAccessLevel = APIAccessLevel = {}));
/**
...
class PluginSecurityManager {
    ...
    validatePermissions(pluginId, requestedPermissions) {
        ...
        if (!context) {
            throw new plugin_interface_1.PluginSecurityError(`No security context found for plugin: ${pluginId}`, pluginId, 'NO_SECURITY_CONTEXT');
        }
        const granted = [];
        const denied = [];
        const violations = [];
    ...
    executeSandboxed(pluginId, code, context = {}) {
        ...
        if (!securityContext.sandbox) {
            throw new plugin_interface_1.PluginSecurityError(`Plugin ${pluginId} is not configured for sandboxed execution`, pluginId, 'NO_SANDBOX_CONFIG');
        }
        return new Promise((resolve, reject) => {
            ...
            const timeout = setTimeout(() => {
                ...
                this.recordViolation(pluginId, violation);
                reject(new plugin_interface_1.PluginSecurityError('Execution timeout', pluginId, 'EXECUTION_TIMEOUT'));
            ...
            try {
                ...
                this.recordViolation(pluginId, violation);
                reject(new plugin_interface_1.PluginSecurityError(`Sandboxed execution failed: ${error.message}`, pluginId, 'SANDBOX_EXECUTION_ERROR', error));
            }
        });
    }
    /**
