...
exports.PluginStorageFactory = exports.DefaultPluginStorageService = exports.StorageEventType = void 0;
...
})(StorageEventType || (exports.StorageEventType = StorageEventType = {}));
/**
...
class DefaultPluginStorageService {
    ...
    async set(key, value) {
        ...
        try {
            ...
            throw new plugin_interface_1.PluginError(`Failed to set storage value for key ${key}: ${error.message}`, this.pluginId, 'STORAGE_SET_ERROR', error);
        }
    }
    /**
    ...
    async get(key) {
        ...
        try {
            ...
            throw new plugin_interface_1.PluginError(`Failed to get storage value for key ${key}: ${error.message}`, this.pluginId, 'STORAGE_GET_ERROR', error);
        }
    }
    /**
    ...
    async remove(key) {
        ...
        try {
            ...
            throw new plugin_interface_1.PluginError(`Failed to remove storage value for key ${key}: ${error.message}`, this.pluginId, 'STORAGE_REMOVE_ERROR', error);
        }
    }
    /**
    ...
    async clear() {
        try {
            ...
            throw new plugin_interface_1.PluginError(`Failed to clear plugin storage: ${error.message}`, this.pluginId, 'STORAGE_CLEAR_ERROR', error);
        }
    }
    /**
    ...
    async keys() {
        try {
            ...
            throw new plugin_interface_1.PluginError(`Failed to get storage keys: ${error.message}`, this.pluginId, 'STORAGE_KEYS_ERROR', error);
        }
    }
    /**
    ...
    async setShared(namespace, key, value) {
        ...
        try {
            ...
            throw new plugin_interface_1.PluginError(`Failed to set shared storage value: ${error.message}`, this.pluginId, 'SHARED_STORAGE_SET_ERROR', error);
        }
    }
    /**
    ...
    async getShared(namespace, key) {
        ...
        try {
            ...
            throw new plugin_interface_1.PluginError(`Failed to get shared storage value: ${error.message}`, this.pluginId, 'SHARED_STORAGE_GET_ERROR', error);
        }
    }
    /**
    ...
    async removeShared(namespace, key) {
        ...
        try {
            ...
            throw new plugin_interface_1.PluginError(`Failed to remove shared storage value: ${error.message}`, this.pluginId, 'SHARED_STORAGE_REMOVE_ERROR', error);
        }
    }
    /**
    ...
    async getConfig() {
        try {
            ...
            throw new plugin_interface_1.PluginError(`Failed to get plugin configuration: ${error.message}`, this.pluginId, 'CONFIG_GET_ERROR', error);
        }
    }
    /**
    ...
    async setConfig(config) {
        try {
            ...
            throw new plugin_interface_1.PluginError(`Failed to set plugin configuration: ${error.message}`, this.pluginId, 'CONFIG_SET_ERROR', error);
        }
    }
    /**
    ...
    async migrate(version, migrationFn) {
        try {
            ...
            throw new plugin_interface_1.PluginError(`Storage migration failed: ${error.message}`, this.pluginId, 'STORAGE_MIGRATION_ERROR', error);
        }
    }
    /**
    ...
    async getStatistics() {
        try {
            ...
            throw new plugin_interface_1.PluginError(`Failed to get storage statistics: ${error.message}`, this.pluginId, 'STORAGE_STATS_ERROR', error);
        }
    }
    /**
    ...
    async cleanup() {
        try {
            ...
            throw new plugin_interface_1.PluginError(`Storage cleanup failed: ${error.message}`, this.pluginId, 'STORAGE_CLEANUP_ERROR', error);
        }
    }
    /**
...
exports.DefaultPluginStorageService = DefaultPluginStorageService;
/**
...
exports.PluginStorageFactory = PluginStorageFactory;
