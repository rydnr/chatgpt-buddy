...
exports.ChatGPTBuddyPlugin = exports.ChatGPTPluginEvents = void 0;
/**
 * ChatGPT Plugin Events
 */
exports.ChatGPTPluginEvents = {
...
class ChatGPTBuddyPlugin {
    ...
    async activate() {
        ...
        try {
            ...
            await this.context.eventBus.emit({
                type: exports.ChatGPTPluginEvents.AI_INTERACTION_REQUESTED,
                source: this.id,
                data: { activated: true },
        ...
        try {
            switch (event.type) {
                ...
                case 'training:session:started':
                    ...
                    break;
                case exports.ChatGPTPluginEvents.AI_MODEL_SWITCHED:
    ...
    async sendMessage(message, options) {
        ...
        try {
            ...
            // Emit event
            await this.context.eventBus.emit({
                type: exports.ChatGPTPluginEvents.CHATGPT_MESSAGE_SENT,
                source: this.id,
                data: {
                    message,
                    options,
    ...
    async getLatestResponse(options) {
        ...
        try {
            ...
            // Emit event
            await this.context.eventBus.emit({
                type: exports.ChatGPTPluginEvents.CHATGPT_RESPONSE_EXTRACTED,
                source: this.id,
                data: {
                    response,
                    responseTime,
    ...
    async startNewConversation() {
        ...
        try {
            ...
            // Emit event
            await this.context.eventBus.emit({
                type: exports.ChatGPTPluginEvents.CONVERSATION_STARTED,
                source: this.id,
                data: {
                    timestamp: new Date().toISOString()
                },
...
exports.ChatGPTBuddyPlugin = ChatGPTBuddyPlugin;
...
class AIModelManager {
    ...
    async start() {
        ...
        // Set up event listeners
        this.context.eventBus.on(exports.ChatGPTPluginEvents.AI_MODEL_SWITCHED, (event) => {
    ...
    async switchToModel(modelId, reason) {
        ...
        // Emit event
        await this.context.eventBus.emit({
            type: exports.ChatGPTPluginEvents.AI_MODEL_SWITCHED,
...
class TrainingManager {
    ...
    async start() {
        ...
        // Set up event listeners
        this.context.eventBus.on(exports.ChatGPTPluginEvents.TRAINING_MODE_ENABLED, (event) => {
            this.handleTrainingModeEnabled(event);
        });
        this.context.eventBus.on(exports.ChatGPTPluginEvents.TRAINING_PATTERN_LEARNED, (event) => {
    ...
    async enableTrainingMode() {
        ...
        await this.context.eventBus.emit({
            type: exports.ChatGPTPluginEvents.TRAINING_MODE_ENABLED,
    ...
    async endTrainingSession(sessionId, reason) {
        ...
        await this.context.eventBus.emit({
            type: exports.ChatGPTPluginEvents.TRAINING_SESSION_COMPLETED,
            source: 'training-manager',
            data: {
                sessionId,
                patternsLearned: finalPatterns.length,
    ...
    async improvePattern(patternId, feedback) {
        ...
        if (feedback.success && pattern.confidence > 0.9) {
            await this.context.eventBus.emit({
                type: exports.ChatGPTPluginEvents.TRAINING_PATTERN_LEARNED,
                source: 'training-manager',
                data: {
                    patternId,
                    confidence: pattern.confidence,
...
class AutomationEngine {
    ...
    async start() {
        ...
        // Set up event listeners
        this.context.eventBus.on(exports.ChatGPTPluginEvents.CHATGPT_MESSAGE_SENT, (event) => {
            this.handleMessageSent(event);
        });
        this.context.eventBus.on(exports.ChatGPTPluginEvents.CHATGPT_RESPONSE_EXTRACTED, (event) => {
...
class PerformanceTracker {
    ...
    async start() {
        ...
        // Set up event listeners
        this.context.eventBus.on(exports.ChatGPTPluginEvents.AI_RESPONSE_RECEIVED, (event) => {
            this.handleResponseReceived(event);
        });
        this.context.eventBus.on(exports.ChatGPTPluginEvents.AI_PERFORMANCE_UPDATED, (event) => {
    ...
    async recordPerformanceData(data) {
        ...
        await this.context.eventBus.emit({
            type: exports.ChatGPTPluginEvents.AI_PERFORMANCE_UPDATED,
...
//# sourceMappingURL=chatgpt-buddy-plugin.js.map