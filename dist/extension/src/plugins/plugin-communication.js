...
exports.PluginCommunicationHelpers = exports.PluginCommunicationFactory = exports.DefaultPluginMessaging = exports.DefaultPluginEventBus = exports.PluginMessageType = void 0;
...
})(PluginMessageType || (exports.PluginMessageType = PluginMessageType = {}));
/**
...
class DefaultPluginEventBus {
    ...
    async emit(event) {
        try {
            ...
            throw new plugin_interface_1.PluginError(`Failed to emit event ${event.type}: ${error.message}`, event.source, 'EVENT_EMISSION_ERROR', error);
        }
    }
    /**
...
exports.DefaultPluginEventBus = DefaultPluginEventBus;
/**
 * Plugin messaging implementation
 */
class DefaultPluginMessaging {
        ...
        if (message.to) {
            ...
            if (handler) {
                try {
                    ...
                    throw new plugin_interface_1.PluginError(`Message delivery failed to ${message.to}: ${error.message}`, message.from, 'MESSAGE_DELIVERY_ERROR', error);
                }
            }
            else {
                throw new plugin_interface_1.PluginError(`No message handler registered for plugin: ${message.to}`, message.from, 'NO_MESSAGE_HANDLER');
            }
        }
        else {
            // Broadcast message
...
exports.DefaultPluginMessaging = DefaultPluginMessaging;
/**
 * Plugin communication factory
 */
class PluginCommunicationFactory {
    constructor() {
...
exports.PluginCommunicationFactory = PluginCommunicationFactory;
/**
 * Helper functions for common communication patterns
 */
class PluginCommunicationHelpers {
    /**
...
exports.PluginCommunicationHelpers = PluginCommunicationHelpers;
//# sourceMappingURL=plugin-communication.js.map