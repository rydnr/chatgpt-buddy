...
exports.PatternMatchingAdapter = void 0;
const training_events_1 = require("../domain/events/training-events");
const pattern_storage_adapter_1 = require("./pattern-storage-adapter");
class PatternMatchingAdapter {
    constructor(storageAdapter) {
        this.patternCache = new Map();
        this.cacheTimeout = 5 * 60 * 1000; // 5 minutes
        this.lastCacheUpdate = 0;
        this.storageAdapter = storageAdapter || new pattern_storage_adapter_1.PatternStorageAdapter();
    }
    ...
    async handleAutomationRequest(request) {
        ...
        if (bestMatch && this.isMatchAcceptable(bestMatch)) {
            return new training_events_1.AutomationPatternMatched(bestMatch.pattern, request, bestMatch.confidence, this.generateCorrelationId());
        }
        return null;
    }
...
exports.PatternMatchingAdapter = PatternMatchingAdapter;
//# sourceMappingURL=pattern-matching-adapter.js.map