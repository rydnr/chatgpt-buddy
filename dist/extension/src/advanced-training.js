...
exports.globalAdvancedTrainingManager = exports.WorkflowExecutor = exports.TrainingSession = exports.AdvancedTrainingManager = void 0;
...
class AdvancedTrainingManager {
    ...
    async createTrainingScenario(name, category, difficulty, steps, options = {}) {
        ...
        message_store_1.globalMessageStore.addInboundMessage('TRAINING_SCENARIO_CREATED', { scenarioId: scenario.id, name, category, difficulty }, `scenario-created-${Date.now()}`, { extensionId: chrome.runtime.id, userAgent: navigator.userAgent });
    ...
    async startTrainingSession(scenarioId, userId = 'anonymous') {
        ...
        message_store_1.globalMessageStore.addInboundMessage('TRAINING_SESSION_STARTED', { sessionId: session.id, scenarioId, userId }, `session-started-${Date.now()}`, { extensionId: chrome.runtime.id, userAgent: navigator.userAgent });
    ...
    async createWorkflowTemplate(name, phases, options = {}) {
        ...
        message_store_1.globalMessageStore.addInboundMessage('WORKFLOW_CREATED', { workflowId: workflow.id, name, complexity: workflow.complexity }, `workflow-created-${Date.now()}`, { extensionId: chrome.runtime.id, userAgent: navigator.userAgent });
...
exports.AdvancedTrainingManager = AdvancedTrainingManager;
/**
...
exports.globalAdvancedTrainingManager = new AdvancedTrainingManager();
//# sourceMappingURL=advanced-training.js.map