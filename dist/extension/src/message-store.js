...
exports.globalMessageStore = exports.MessageStore = exports.messageStoreSelectors = exports.messageStoreActions = exports.MESSAGE_STORE_ACTIONS = void 0;
exports.messageStoreReducer = messageStoreReducer;
// Action types
exports.MESSAGE_STORE_ACTIONS = {
...
// Action creators
exports.messageStoreActions = {
    addMessage: (message, metadata) => ({
        type: exports.MESSAGE_STORE_ACTIONS.ADD_MESSAGE,
        payload: message,
        meta: {
            timestamp: Date.now(),
    ...
    updateMessageStatus: (correlationId, status, response, error) => ({
        type: exports.MESSAGE_STORE_ACTIONS.UPDATE_MESSAGE_STATUS,
    ...
    timeTravelTo: (index) => ({
        type: exports.MESSAGE_STORE_ACTIONS.TIME_TRAVEL_TO,
        payload: { index },
        meta: {
            timestamp: Date.now(),
    ...
    resetTimeTravel: () => ({
        type: exports.MESSAGE_STORE_ACTIONS.RESET_TIME_TRAVEL,
        payload: {},
        meta: {
            timestamp: Date.now(),
    ...
    setFilters: (filters) => ({
        type: exports.MESSAGE_STORE_ACTIONS.SET_FILTERS,
        payload: filters,
        meta: {
            timestamp: Date.now(),
    ...
    clearMessages: () => ({
        type: exports.MESSAGE_STORE_ACTIONS.CLEAR_MESSAGES,
        payload: {},
        meta: {
            timestamp: Date.now(),
    ...
    loadPersistedMessages: (messages) => ({
        type: exports.MESSAGE_STORE_ACTIONS.LOAD_PERSISTED_MESSAGES,
        payload: { messages },
        meta: {
            timestamp: Date.now(),
...
// Reducer
function messageStoreReducer(state = initialState, action) {
    switch (action.type) {
        case exports.MESSAGE_STORE_ACTIONS.ADD_MESSAGE: {
            const newMessage = {
                ...action.payload,
        ...
        case exports.MESSAGE_STORE_ACTIONS.UPDATE_MESSAGE_STATUS: {
        ...
        case exports.MESSAGE_STORE_ACTIONS.TIME_TRAVEL_TO: {
        ...
        case exports.MESSAGE_STORE_ACTIONS.RESET_TIME_TRAVEL: {
            return {
                ...state,
        ...
        case exports.MESSAGE_STORE_ACTIONS.SET_FILTERS: {
            return {
                ...state,
                filters: {
                    ...state.filters,
        ...
        case exports.MESSAGE_STORE_ACTIONS.CLEAR_MESSAGES: {
            return {
                ...state,
                messages: [],
                currentIndex: -1,
        ...
        case exports.MESSAGE_STORE_ACTIONS.LOAD_PERSISTED_MESSAGES: {
...
class MessageStore {
    ...
    async loadPersistedState() {
        try {
            ...
            if (persistedData && persistedData.messages && Array.isArray(persistedData.messages)) {
                this.dispatch(exports.messageStoreActions.loadPersistedMessages(persistedData.messages));
    ...
    addInboundMessage(type, payload, correlationId, metadata) {
        this.dispatch(exports.messageStoreActions.addMessage({
            type,
            payload,
            correlationId,
            direction: 'inbound',
    ...
    markMessageSuccess(correlationId, response) {
        this.dispatch(exports.messageStoreActions.updateMessageStatus(correlationId, 'success', response));
    }
    markMessageError(correlationId, error) {
        this.dispatch(exports.messageStoreActions.updateMessageStatus(correlationId, 'error', undefined, error));
    }
    timeTravelTo(index) {
        this.dispatch(exports.messageStoreActions.timeTravelTo(index));
    }
    resetTimeTravel() {
        this.dispatch(exports.messageStoreActions.resetTimeTravel());
    }
    clearAllMessages() {
        this.dispatch(exports.messageStoreActions.clearMessages());
    }
    ...
    importMessages(jsonData) {
        try {
            ...
            if (data.messages && Array.isArray(data.messages)) {
                this.dispatch(exports.messageStoreActions.loadPersistedMessages(data.messages));
                return true;
            }
            return false;
        }
...
exports.globalMessageStore = new MessageStore();
