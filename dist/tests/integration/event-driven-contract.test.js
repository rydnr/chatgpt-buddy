...
describe('🔗 Event-Driven Contract Tests', () => {
    ...
    describe('🔄 Chrome Extension Communication', () => {
        test('should send messages via chrome.tabs.sendMessage', async () => {
            ...
            mockChrome.tabs.sendMessage.mockImplementation((...args) => {
            ...
            let response;
            mockChrome.tabs.sendMessage(tabId, message, (result) => {
                response = result;
            });
    ...
    describe('🧪 Event-Driven SDK Contract', () => {
        test('should support async event sending pattern', async () => {
            ...
            class MockEventDrivenClient {
                ...
                async requestProjectSelection(extensionId, tabId, projectName) {
                    const event = {
            ...
            const result = await client.requestProjectSelection('ext-123', 456, 'coding-assistant');
        ...
        test('should support batch event operations', async () => {
            class MockEventDrivenClient {
                async sendEvents(events, parallel = false) {
                    if (parallel) {
...
//# sourceMappingURL=event-driven-contract.test.js.map