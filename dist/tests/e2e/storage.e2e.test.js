...
test_1.test.describe('🔴 IndexedDB Storage E2E Tests', () => {
    ...
    (0, test_1.test)('🔴 should persist automation patterns to IndexedDB', async ({ page }) => {
        ...
        (0, test_1.expect)(storageStats).toBeDefined();
        (0, test_1.expect)(storageStats.automationPatterns).toBeGreaterThan(0);
        (0, test_1.expect)(storageStats.userInteractions).toBeGreaterThan(0);
    });
    (0, test_1.test)('🔴 should retrieve and apply existing automation patterns', async ({ page }) => {
        ...
        (0, test_1.expect)(patterns).toBeDefined();
        (0, test_1.expect)(patterns.length).toBeGreaterThan(0);
        (0, test_1.expect)(patterns[0].action).toBe('clickElement');
        (0, test_1.expect)(patterns[0].selector).toBe('#test-button');
    });
    (0, test_1.test)('🔴 should save user interactions with context', async ({ page }) => {
        ...
        (0, test_1.expect)(interactions).toBeDefined();
    ...
    (0, test_1.test)('🔴 should clear old data correctly', async ({ page }) => {
        ...
        (0, test_1.expect)(finalStats).toBeDefined();
    ...
    (0, test_1.test)('🔴 should handle storage errors gracefully', async ({ page }) => {
        ...
        (0, test_1.expect)(errorResult.success).toBe(false);
        (0, test_1.expect)(errorResult.error).toBeDefined();
    });
    (0, test_1.test)('🔴 should provide accurate storage statistics', async ({ page }) => {
        ...
        (0, test_1.expect)(stats).toBeDefined();
        (0, test_1.expect)(stats.automationPatterns).toBe(3);
        (0, test_1.expect)(stats.userInteractions).toBe(2);
        (0, test_1.expect)(stats.websiteConfigs).toBe(1);
    });
});
test_1.test.describe('🟢 IndexedDB Storage Integration with Extension UI', () => {
    (0, test_1.test)('🟢 should display storage stats in popup', async ({ page, context }) => {
...
//# sourceMappingURL=storage.e2e.test.js.map