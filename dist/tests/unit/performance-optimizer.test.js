...
const performance_optimizer_1 = require("../../extension/src/performance-optimizer");
describe('🚀 Performance Optimizer', () => {
    let optimizer;
    let mockMessages;
    beforeEach(() => {
        globals_1.jest.clearAllMocks();
        optimizer = new performance_optimizer_1.PerformanceOptimizer();
    ...
    describe('💾 Message Caching', () => {
        ...
        test('should handle cache TTL expiration', async () => {
            ...
            Date.now = globals_1.jest.fn(() => originalDateNow() + 6 * 60 * 1000);
            const cached = optimizer.getCachedMessage(message.correlationId);
    ...
    describe('🔍 Optimized Filtering', () => {
        ...
        test('should handle multiple filter values', () => {
            ...
            expect(multiTypeResults.every(msg => msg.type === 'TestMessage0' || msg.type === 'TestMessage1')).toBe(true);
        });
    });
...
//# sourceMappingURL=performance-optimizer.test.js.map