...
const plugin_storage_1 = require("../extension/src/plugins/plugin-storage");
...
describe('Plugin System Core Components', () => {
    ...
    describe('Plugin Event Bus', () => {
        test('should create event bus and handle events', async () => {
            const eventBus = new plugin_communication_1.DefaultPluginEventBus();
            const testEvent = {
                type: 'test:event',
                source: 'test-plugin',
    ...
    describe('Plugin Messaging', () => {
        test('should support pub/sub messaging', async () => {
            const eventBus = new plugin_communication_1.DefaultPluginEventBus();
            const messaging = new plugin_communication_1.DefaultPluginMessaging(eventBus);
    ...
    describe('Plugin Storage', () => {
        test('should create isolated plugin storage', async () => {
            const storage1 = new plugin_storage_1.DefaultPluginStorageService('plugin-1');
            const storage2 = new plugin_storage_1.DefaultPluginStorageService('plugin-2');
        ...
        test('should handle plugin configuration', async () => {
            const storage = new plugin_storage_1.DefaultPluginStorageService('test-plugin');
    ...
    describe('Plugin Storage Factory', () => {
        test('should create isolated storage instances', () => {
            const factory = new plugin_storage_1.PluginStorageFactory();
    ...
    describe('Plugin Communication Factory', () => {
        test('should create communication infrastructure', () => {
            const factory = new plugin_communication_1.PluginCommunicationFactory();
