...
export class GoogleSearchHandler implements MessageHandler {
  async handle(message: WebBuddyMessage): Promise<SearchResponse> {
    switch (message.type) {
   ...
   */
  private async enterSearchTerm(term: string): Promise<SearchResponse> {
    try {
   ...
   */
  private async getFirstResult(): Promise<SearchResponse> {
    try {
   ...
   */
  private async clickResult(index: number): Promise<SearchResponse> {
    try {
   ...
   */
  private async extractPageTitle(): Promise<SearchResponse> {
    try {
