...
exports.WebBuddyTestEnvironment = void 0;
...
class WebBuddyTestEnvironment {
    ...
    webBuddyClient = null;
    extensionId = null;
    constructor(config, implementationName) {
        this.config = config;
     ...
     * Initialize Web-Buddy client
     */
    initializeWebBuddyClient() {
        this.webBuddyClient = new core_1.WebBuddyClient({
    ...
    async waitForExtensionReady() {
        ...
        await this.page.waitForFunction(() => {
            return window.webBuddyExtensionReady === true ||
                typeof window.webBuddyClient !== 'undefined';
        }, { timeout: this.config.timeout });
...
exports.WebBuddyTestEnvironment = WebBuddyTestEnvironment;
/**
 * Factory function to create test environment with default settings
 */
function createTestEnvironment(implementationName, options = {}) {
    const defaultConfig = {
        browser: 'chromium',
 ...
 */
async function quickSetup(implementationName, url, options = {}) {
...
//# sourceMappingURL=playwright-integration.js.map